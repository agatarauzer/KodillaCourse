...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://agatarauzer.github.io/";
    ...
    private void deleteTestTask(String taskName) throws InterruptedException {
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).getText().equals(taskName))
                .forEach(theForm -> {
                    WebElement buttonDeleteTask = theForm.findElement(By.xpath(".//fieldset[contains(@class, \"button-section\")]/button[4]"));
