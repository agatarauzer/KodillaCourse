...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHands_userHaveNoBooks() {
        //Given
        List<Book> resultListOfBooks = new ArrayList<>();
        LibraryUser user = new LibraryUser("Ala", "Kowalska", "123456789");
        ...
        //Then
        Assert.assertEquals(0, booksInHands.size());
    }

    @Test
    public void testListBooksInHands_userHaveOneBook() {
        //Given
        ...
        //Then
        Assert.assertEquals(1, booksInHands.size());
    }

    @Test
    public void testListBooksInHands_userHaveFiveBooks() {
        //Given
        ...
        //Then
        Assert.assertEquals(5, booksInHands.size());
    }
